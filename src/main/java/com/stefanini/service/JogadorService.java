...
public class JogadorService {
	...
	public void salvar(JogadorNovoDTO jogador) {
		...
		try {
			...
			// TODO: Implementar verificacao do erro, mas provavelmente sera por conta de
			// entradas duplicadas
			// Com mais tempo, seria implementada uma classe específica somente para os
			// casos de erro, verificando
	...
	public void login(@Valid JogadorNovoDTO jogador) {
		try {
			...
			login.autenticarUsuario(jogador.getNickname(), jogador.getPassword()).getSingleResult();
		} catch (Exception ex) {
